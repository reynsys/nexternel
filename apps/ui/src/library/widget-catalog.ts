...
const CORE_CATALOG: CatalogEntry[] = [
  ...
  },
  {
    type: "switch",
    label: "Switch (toggle)",
    description: "Classic ON/OFF label with MUI toggle",
    category: "controls",
    needsCapability: true,
  },
  {
    type: "switch_icon",
    label: "Switch (icon tile)",
    description: "Large centre icon — accent when on, muted when off",
    category: "controls",
    needsCapability: true,
    defaultConfig: { iconId: "lights" },
  },
  {
    type: "switch_power",
    label: "Switch (power button)",
    description: "Round icon button with accent fill when on",
    category: "controls",
    needsCapability: true,
    defaultConfig: { iconId: "lights" },
  },
  {
    type: "switch_pill",
    label: "Switch (ON / OFF buttons)",
    description: "Explicit ON and OFF buttons",
    category: "controls",
    needsCapability: true,
  },
  {
    ...
    description: "Icon plus small toggle",
    category: "controls",
    needsCapability: true,
    defaultConfig: { iconId: "lights" },
  },
  {
    type: "switch_button",
    label: "Action button",
    description: "Labelled button — filled, outline, or flat; toggles on tap",
    category: "controls",
    needsCapability: true,
    defaultConfig: {
      iconId: "lights",
  ...
  },
  {
    ...
    label: "Momentary pulse",
    description: "Brief ON pulse then OFF — gates, doorbells, latching relays",
    category: "controls",
    needsCapability: true,
    defaultConfig: { iconId: "power", pulseMs: 500, showButtonIcon: true },
  },
  {
    type: "calendar",
    label: "Calendar",
